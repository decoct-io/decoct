#!/usr/bin/env python3
"""Run the entity-graph pipeline on telco-5g fixtures and dump Tier A/B/C YAML."""
...
def main() -> None:
    ...
    spec = load_ingestion_spec("specs/ingestion/telco-5g/ingestion_spec.yaml")
