#!/usr/bin/env python3
"""Run the entity-graph pipeline on enterprise-campus fixtures and dump Tier A/B/C YAML."""
...
OUT_DIR = Path("output/enterprise-campus")
...
def main() -> None:
    ...
    spec = load_ingestion_spec("specs/ingestion/enterprise-campus/ingestion_spec.yaml")
