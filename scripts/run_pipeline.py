#!/usr/bin/env python3
"""Run the entity-graph pipeline on IOS-XR fixtures and dump Tier A/B/C YAML."""
...
OUT_DIR = Path("output/entity-graph")
...
def main() -> None:
    ...
    print(f"  Types discovered: {list(result.type_map.keys())}")
