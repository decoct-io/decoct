#!/usr/bin/env python3
"""Run the entity-graph pipeline on k8s-fleet fixtures and dump Tier A/B/C YAML."""
...
def main() -> None:
    ...
    spec = load_ingestion_spec("specs/ingestion/k8s-fleet/ingestion_spec.yaml")
